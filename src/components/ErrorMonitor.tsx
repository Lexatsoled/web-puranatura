...
import { errorLogger, type ErrorLogEntry, ErrorSeverity } from '../services/errorLogger';
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {(['all', ErrorSeverity.LOW, ErrorSeverity.MEDIUM, ErrorSeverity.HIGH, ErrorSeverity.CRITICAL] as const).map((severity) => (
          <button
            key={severity}
