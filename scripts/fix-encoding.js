...
const looksMojibake = (s) => /[ÃÂâ�]/.test(s) || /InformaciÃ³n|DescripciÃ³n|opciÃ³n|cuÃ¡|niÃ±|mÃ¡s|pÃº|tÃ­tulo/.test(s);
const scoreMojibake = (s) => (s.match(/[ÃÂâ�]/g) || []).length + (s.match(/Ãƒ|Ã¢|Ã©|Ã³|Ã¡/g) || []).length;
