...
exports.products = exports.productCategories = void 0;
const image_manifest_json_1 = __importDefault(require('./image-manifest.json'));
const manifestEntries = image_manifest_json_1.default;
...
const legacyProducts = [
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Los suplementos de calcio y magnesio pueden interactuar con ciertos medicamentos para la presión arterial, especialmente los bloqueadores de los canales de calcio y los diuréticos. Consulte con su médico antes de comenzar la suplementación si está tomando estos u otros medicamentos recetados para asegurar que no haya interacciones significativas.',
      },
      {
  ...
  },
  {
    ...
    price: 715.61,
    description:
      'Extracto estandarizado de raíz de Ashwagandha. Adaptógeno ayurvédico que ayuda a manejar el estrés, apoya la energía y promueve un sueño reparador.',
  ...
  // Neurotransmisores y Estado de Ánimo
  {
    ...
    price: 1085.65,
    description:
      'GABA, neurotransmisor inhibidor natural que promueve la calma y relajación. Apoya la reducción del estrés y un estado mental equilibrado.',
  ...
  // Antioxidantes y Antiinflamatorios
  {
    ...
    price: 1909.29,
    description:
      'Cúrcuma estandarizada con bioperina (pimienta negra) para máxima absorción. Potente antiinflamatorio natural y antioxidante.',
  ...
  },
  {
    ...
    price: 1163.24,
    description:
      'Coenzima Q10 de alta potencia para apoyar la salud cardiovascular y producción de energía celular. Antioxidante esencial para el corazón.',
  ...
  },
  {
    ...
    price: 536.26,
    description:
      'Aceite de árnica puro para uso tópico. Tradicionalmente usado para apoyar la recuperación muscular y alivio de molestias menores.',
  ...
  // Suplementos Especializados Adicionales
  {
    ...
    price: 2173.09,
    description:
      'Presentación económica de Ashwagandha. Extracto estandarizado de raíz para manejo del estrés, energía y bienestar general a largo plazo.',
  ...
  // Desintoxicación Adicional
  {
    ...
    price: 596.76,
    description:
      'Programa completo de limpieza hepática de 3 días con mezcla de hierbas tradicionales para apoyar la función de desintoxicación natural.',
  ...
  // Aceites Esenciales Finales
  {
    ...
    price: 319.98,
    description:
      'Pack económico de aceite esencial de manzanilla. Ideal para uso regular en aromaterapia, relajación y cuidado natural de la piel.',
  ...
  },
  {
    ...
    price: 319.98,
    description:
      'Pack económico de aceite esencial de sándalo. Perfecto para meditación, relajación profunda y prácticas espirituales regulares.',
  ...
  // Suplementos para Rendimiento Mental
  {
    ...
    price: 716.6,
    description:
      'Pack económico de fórmula para sueño reparador. Combina adaptógenos y melatonina para un descanso profundo y reparador.',
  ...
  // Salud Celular Avanzada
  {
    ...
    price: 1089.88,
    description:
      'GABA individual para manejo del estrés y promoción de la calma mental. Neurotransmisor natural para equilibrio emocional.',
  ...
  // Productos Adicionales de Piping Rock
  {
    ...
    price: 187.12,
    description:
      'Extracto líquido de caléndula para apoyo en cuidado de la piel y bienestar general. Formato líquido de fácil absorción.',
  ...
  },
  {
    ...
    price: 374.92,
    description:
      'DHEA adicional para balance hormonal y vitalidad. Presentación alternativa del suplemento hormonal premium.',
  ...
  },
  {
    ...
    price: 156.42,
    description:
      'Raíz de regaliz tradicional para apoyo respiratorio y digestivo. Hierba adaptógena con múltiples beneficios.',
  ...
  },
  {
    ...
    price: 124.62,
    description:
      'Aceite de borraja rico en GLA para salud de la piel y balance hormonal femenino. Ácidos grasos esenciales.',
  ...
  },
  {
    ...
    price: 187.12,
    description:
      'Vitamina C con escaramujos para potenciar la absorción. Presentación extra económica con bioflavonoides naturales.',
  ...
  },
  {
    ...
    price: 187.12,
    description:
      'Palmito salvaje para salud prostática masculina. Extracto estandarizado con ácidos grasos y esteroles.',
  ...
  },
  {
    ...
    price: 187.12,
    description:
      'L-Serina para función cerebral y síntesis de neurotransmisores. Aminoácido esencial para salud neurológica.',
  ...
  },
  {
    ...
    price: 374.92,
    description:
      'Fórmula completa para apoyo durante la menopausia. Presentación adicional con hierbas tradicionales y nutrientes.',
  ...
  },
  {
    ...
    price: 156.42,
    description:
      'Vinagre de sidra de manzana para apoyo digestivo y metabólico. Rico en ácido acético y enzimas naturales.',
  ...
  },
  {
    ...
    price: 62.36,
    description:
      'Aceite esencial puro de nuez moscada para aromaterapia. Probado por GC/MS para garantizar pureza y potencia.',
  ...
  },
  {
    ...
    price: 124.62,
    description:
      'Aceite esencial de baya de enebro del Himalaya para aromaterapia. Calidad premium con certificación GC/MS.',
  ...
  },
  {
    ...
    price: 218.62,
    description:
      'Aceite esencial de hoja de canela en presentación grande. Propiedades calmantes y aromáticas intensas.',
  ...
  },
  {
    ...
    price: 37.99,
    description:
      'Fórmula avanzada de cúrcuma con curcumina concentrada. Máxima potencia antiinflamatoria con biodisponibilidad mejorada.',
    images: [
      {
        thumbnail: '/Jpeg/Standardized Turmeric Curcumin Reverso.jpg',
        full: '/Jpeg/Standardized Turmeric Curcumin Reverso.jpg',
  ...
  // Nuevos productos con imágenes reales de Piping Rock
  {
    ...
    price: 29.99,
    description:
      'Ashwagandha de alta potencia para reducir el estrés y mejorar la energía natural.',
    images: [
      {
        thumbnail: '/Jpeg/Ashwagandha, 4500 mg Reverso.jpg',
        full: '/Jpeg/Ashwagandha, 4500 mg Reverso.jpg',
  ...
  },
  {
    ...
    price: 24.99,
    description:
      'GABA para promover la relajación y mejorar la calidad del sueño.',
    images: [
      {
        thumbnail: '/Jpeg/GABA Reverso.jpg',
        full: '/Jpeg/GABA Reverso.jpg',
  ...
  },
  {
    ...
    price: 19.99,
    description:
      'Citrato de magnesio de alta absorción para músculos y nervios.',
    images: [
      {
...
exports.products = legacyProducts.map(normalizeProductImages);
