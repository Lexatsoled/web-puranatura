...
export const blogPosts: BlogPost[] = [
    {
        ...
        summary: "La fitoterapia, o medicina herbal, es una de las formas más antiguas de atención médica. Descubre cómo las plantas medicinales pueden tratar diversas afecciones y mejorar tu salud general de manera segura y efectiva.",
    ...
    },
    {
        ...
        summary: "En el ajetreo diario, encontrar momentos de calma es crucial. La aromaterapia ofrece una solución natural. Te presentamos 5 aceites esenciales, como la lavanda y la manzanilla, que te ayudarán a relajarte.",
    ...
    },
    {
        ...
        summary: "Tu intestino es tu segundo cerebro. Mantener una flora intestinal saludable es vital para tu bienestar. Aprende por qué los probióticos son clave para una buena digestión, un sistema inmune fuerte y mucho más.",
    ...
    },
    {
        ...
        summary: "Plantas como la Ashwagandha y la Rhodiola son conocidas como adaptógenos. Descubre cómo estas maravillas de la naturaleza ayudan a tu cuerpo a adaptarse al estrés físico y mental, mejorando tu resistencia y energía.",
    ...
    },
    {
        ...
        summary: "El magnesio participa en más de 300 reacciones bioquímicas en el cuerpo. Desde la función muscular hasta la salud ósea y cardiovascular, exploramos por qué este mineral es tan esencial para tu salud diaria.",
