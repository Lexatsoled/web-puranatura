...
| Seguridad                                                           | Escaneo secretos + dependencias + XSS | `gitleaks`, `npm audit`, payload XSS en blog/contacto                                               | `gitleaks detect && npm audit --production` (en PowerShell use `;` o ejecute los comandos por separado)                     |
