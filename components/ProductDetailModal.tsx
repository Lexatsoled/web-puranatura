            ...
            >
                ...
                <div className="w-full md:w-1/2 p-6 flex flex-col">
                    <div className="flex-grow overflow-y-auto">
                        <h2 className="text-3xl font-bold font-display text-gray-800">{product.name}</h2>
                        <p className="text-md text-gray-500 mt-1 mb-4">{product.category}</p>
                        <p className="text-gray-600 leading-relaxed mb-6">{product.description}</p>
                        
                    </div>
                    <div className="mt-auto pt-4 border-t">
                        <div className="flex justify-between items-center">
                            <p className="text-3xl font-bold text-green-700">DOP ${product.price.toFixed(2)}</p>
                            <button
