...
| Bajo | Datos publicos | VITE_* | Revision anual |
...
- `.env`: valores publicos con prefijo VITE_.
...
Objetivo: Agregar una variable VITE_* sin exponer datos sensibles
...
P: Como se si una variable debe ser VITE_*?
...
### Netlify frontend
1. Revisar variables en UI y confirmar prefijo VITE_.
