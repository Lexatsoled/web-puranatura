...
2. En GitHub, abre la pestaña Actions y ejecuta manualmente `Deploy to staging` (workflow_dispatch). Si no tienes credenciales de despliegue (por ejemplo `DOCKERHUB_*`), el job terminará en modo dry-run.
