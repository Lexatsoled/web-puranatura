module.exports = [
  ...
  // 🛡️ SISTEMA INMUNOLÓGICO - Productos específicos para fortalecer las defensas naturales
  {
    ...
    price: 3456.78,
    description:
      'Fórmula sinérgica completa que combina Vitamina C, D3, Zinc, Equinácea, Saúco y hongos medicinales. Apoyo integral para el sistema inmunológico durante todo el año.',
    images: [
      {
    ...
    components: [
      {
        name: 'Vitamina C (como ascorbato de calcio)',
        description:
          'Antioxidante esencial y cofactor para la síntesis de colágeno e interferón. Apoya la función de neutrófilos y células NK.',
        amount: '1000 mg (1111% VD)',
      },
      {
        name: 'Vitamina D3 (colecalciferol)',
        description:
          'Modula la inmunidad innata y adaptativa, regula la expresión de péptidos antimicrobianos como catelicidina.',
        amount: '4000 UI (1000% VD)',
      },
      {
        name: 'Zinc (como bisglicinato quelado)',
        description:
          'Mineral esencial para más de 300 enzimas, crucial para la función inmune, cicatrización y síntesis proteica.',
        amount: '15 mg (136% VD)',
      },
      {
        name: 'Extracto de Equinácea purpúrea (raíz)',
        description:
          'Estandarizada al 4% de equinacósidos. Estimula la fagocitosis, aumenta la producción de interferón y activa macrófagos.',
        amount: '400 mg',
      },
      {
        name: 'Extracto de Saúco negro (Sambucus nigra)',
        description:
          'Rico en antocianinas y flavonoides. Inhibe la neuraminidasa viral y reduce la duración de infecciones respiratorias.',
        amount: '300 mg',
      },
      {
        name: 'Complejo de hongos medicinales (Reishi, Shiitake, Maitake)',
        description:
          'Estandarizado al 30% de beta-glucanos. Activa receptores de reconocimiento de patrones y estimula células inmunes.',
        amount: '250 mg',
      },
      {
        name: 'Extracto de Astragalus membranaceus (raíz)',
        description:
          'Adaptógeno inmune que fortalece la resistencia a estrés y patógenos. Rico en polisacáridos inmunomoduladores.',
        amount: '200 mg',
      },
      {
        name: 'Quercetina dihidratada',
        description:
          'Flavonoide con propiedades antivirales, antiinflamatorias y estabilizadoras de mastocitos.',
        amount: '100 mg',
      },
    ],
    dosage:
      'Tomar 2 cápsulas al día con alimentos, preferiblemente 1 por la mañana y 1 por la noche. Durante temporadas de alto riesgo o primeros síntomas, puede aumentarse a 3 cápsulas diarias por períodos cortos.',
    administrationMethod:
      'Tomar con alimentos para optimizar la absorción de vitaminas liposolubles. Para máxima efectividad preventiva, usar consistentemente durante temporadas de alto riesgo (otoño-invierno). Puede tomarse de forma continua o en ciclos de 8 semanas con descansos de 1 semana.',
    faqs: [
      {
        question: '¿Cuándo es mejor comenzar a tomarlo?',
        answer:
          'Idealmente, comenzar 2-4 semanas antes de temporadas de alto riesgo (otoño-invierno) para permitir que el sistema inmunológico se fortalezca. También es beneficioso durante períodos de alto estrés o antes de viajes.',
      },
      {
        question: '¿Puedo tomarlo si ya estoy enfermo?',
        answer:
          'Sí, puede ser especialmente beneficioso durante los primeros síntomas. Durante enfermedades activas, puede aumentarse temporalmente a 3 cápsulas diarias hasta la recuperación.',
      },
      {
        question: '¿Es seguro para uso a largo plazo?',
        answer:
          'Sí, todos los componentes son seguros para uso prolongado. Sin embargo, se recomienda hacer pausas ocasionales (1 semana cada 8 semanas) para mantener la sensibilidad del sistema inmune.',
      },
      {
        question: '¿Puede interferir con medicamentos inmunodepresores?',
        answer:
          'Este suplemento estimula el sistema inmunológico, por lo que personas que toman medicamentos inmunodepresores o tienen enfermedades autoinmunes deben consultar con su médico antes del uso.',
      },
    ],
  },

  {
    ...
    price: 2134.56,
    description:
      'Complejo avanzado de Vitamina C con bioflavonoides, escaramujo y acerola. Fórmula de liberación sostenida para protección antioxidante e inmune las 24 horas.',
    images: [
      {
    ...
    components: [
      {
        ...
        description:
          'Forma más potente y rápidamente absorbida de vitamina C, ideal para respuesta inmune inmediata.',
        amount: '500 mg',
      },
      {
        name: 'Ascorbato de Calcio',
        description:
          'Forma tamponada de vitamina C que es gentil con el estómago y proporciona liberación gradual.',
        amount: '300 mg',
      },
      {
        name: 'Palmitato de Ascorbilo',
        description:
          'Forma liposoluble de vitamina C que protege las membranas celulares del daño oxidativo.',
        amount: '100 mg',
      },
      {
        name: 'Extracto de Acerola (25% Vitamina C natural)',
        description:
          'Fuente natural concentrada de vitamina C con cofactores naturales y antioxidantes.',
        amount: '200 mg',
      },
      {
        name: 'Extracto de Escaramujo',
        description:
          'Rico en vitamina C natural, flavonoides y ácidos orgánicos que mejoran la absorción.',
        amount: '150 mg',
      },
      {
        name: 'Complejo de Bioflavonoides Cítricos',
        description:
          'Hesperidina, rutina y naringina que mejoran la absorción y efectos de la vitamina C.',
        amount: '100 mg',
      },
      {
        name: 'Rutina',
        description:
          'Flavonoide que fortalece los capilares sanguíneos y tiene propiedades antiinflamatorias.',
        amount: '50 mg',
      },
    ],
    dosage:
      'Tomar 1-2 comprimidos al día con alimentos. Para apoyo inmunológico intensivo, tomar 1 comprimido cada 8 horas durante períodos de estrés o enfermedad.',
    administrationMethod:
      'Tomar con alimentos para minimizar posible irritación gástrica. La fórmula de liberación sostenida permite tomar menos frecuentemente manteniendo niveles estables. Beber abundante agua para apoyar la eliminación de metabolitos.',
    faqs: [
      {
        question: '¿Qué ventajas tiene sobre la vitamina C regular?',
        answer:
          'Esta fórmula combina múltiples formas de vitamina C para absorción óptima y liberación sostenida, evitando los picos y caídas de las fórmulas simples. Los bioflavonoides mejoran la absorción y prolongan la actividad.',
      },
      {
        question: '¿Es gentil con el estómago?',
        answer:
          'Sí, incluye ascorbato de calcio que es una forma tamponada y gentil con el estómago, reduciendo la acidez típica del ácido ascórbico puro.',
      },
      {
        question: '¿Puedo tomar dosis altas sin problemas?',
        answer:
          'La vitamina C es hidrosoluble y el exceso se elimina por orina. Sin embargo, dosis muy altas (>2000mg) pueden causar molestias digestivas en algunas personas. Esta fórmula está diseñada para proporcionar dosis óptimas sin excesos.',
      },
    ],
  },

  {
    ...
    price: 1567.89,
    description:
      'Zinc altamente biodisponible en forma quelada con aminoácidos. Esencial para función inmune, cicatrización y más de 300 reacciones enzimáticas.',
    images: [
      {
    ...
    detailedDescription:
      'Zinc Immunity Pro proporciona 30mg de zinc elemental en forma de bisglicinato quelado, la forma más biodisponible y gentil con el estómago. El zinc es el segundo oligoelemento más abundante en el cuerpo y cofactor esencial en más de 300 enzimas. Es crucial para la función inmunitaria, síntesis de proteínas, cicatrización de heridas, crecimiento celular y función neurológica. Esta formulación incluye también cobre en proporción 15:1 para mantener el equilibrio mineral adecuado.',
    mechanismOfAction:
    ...
    components: [
      {
        ...
        description:
          'Forma quelada de máxima biodisponibilidad que no compite con otros minerales y es gentil con el estómago.',
        amount: '30 mg (273% VD)',
      },
      {
        name: 'Cobre (como glicinato de cobre)',
        description:
          'Incluido en proporción 15:1 con zinc para mantener el equilibrio mineral y prevenir deficiencia de cobre.',
        amount: '2 mg (222% VD)',
      },
      {
        name: 'Vitamina C (como ascorbato de magnesio)',
        description:
          'Mejora la absorción del zinc y proporciona sinergia antioxidante e inmunológica.',
        amount: '60 mg (67% VD)',
      },
    ],
    dosage:
      'Tomar 1 cápsula al día con alimentos. Para apoyo inmunológico intensivo o durante enfermedades, puede tomarse 1 cápsula dos veces al día por períodos cortos.',
    administrationMethod:
      'Tomar con alimentos para optimizar absorción y minimizar molestias gástricas. Evitar tomar simultáneamente con suplementos de calcio, hierro o antibióticos (espaciar al menos 2 horas). No exceder 40mg diarios de zinc total.',
    faqs: [
      {
        question: '¿Por qué incluye cobre junto con el zinc?',
        answer:
          'El zinc y cobre compiten por absorción. Dosis altas de zinc pueden causar deficiencia de cobre, por lo que incluimos cobre en proporción adecuada (15:1) para mantener el equilibrio mineral.',
      },
      {
        question: '¿Cuál es la diferencia entre zinc quelado y otras formas?',
        answer:
          'El zinc quelado (bisglicinato) se absorbe como un aminoácido intacto, evitando la competencia con otros minerales. Tiene 3-4 veces mejor absorción que formas como óxido o sulfato de zinc.',
      },
      {
        question: '¿Puedo tomar más zinc si estoy enfermo?',
        answer:
          'Durante enfermedades puede aumentarse temporalmente a 2 cápsulas diarias por máximo 7-10 días. Dosis excesivas de zinc pueden interferir con la absorción de cobre y causar desequilibrios.',
      },
    ],
  },
  ...
  // ❤️ SISTEMA CARDIOVASCULAR - Productos para corazón, circulación y salud vascular
  {
    ...
    price: 4567.89,
    description:
      'Fórmula sinérgica avanzada con CoQ10, Omega-3, Magnesio, Hawthorne y Ajo. Apoyo integral para corazón, circulación y presión arterial saludable.',
    images: [
      {
    ...
    detailedDescription:
      'CardioMax Pro es la formulación más completa para la salud cardiovascular, combinando nutrientes esenciales y extractos herbales en dosis terapéuticas basadas en investigación clínica. Esta fórmula sinérgica incluye CoQ10 (fundamental para la energía del músculo cardíaco), Omega-3 EPA/DHA (antiinflamatorios cardiovasculares), Magnesio (relajante vascular natural), extracto de Espino Blanco (tónico cardíaco tradicional) y Ajo envejecido (apoyo circulatorio). Cada componente ha sido seleccionado por su evidencia científica en la promoción de la salud cardíaca y vascular.',
    mechanismOfAction:
    ...
    components: [
      {
        ...
        description:
          'Esencial para la producción de energía en las mitocondrias cardíacas. Mejora la función del músculo cardíaco y actúa como antioxidante.',
        amount: '200 mg',
      },
      {
        name: 'Omega-3 concentrado (EPA/DHA)',
        description:
          'Ácidos grasos esenciales con potentes efectos antiinflamatorios cardiovasculares y protección contra arritmias.',
        amount: '1000 mg (EPA 600mg, DHA 400mg)',
      },
      {
        name: 'Magnesio (como citrato y taurato)',
        description:
          'Mineral esencial que actúa como bloqueador natural de canales de calcio, relajando el músculo vascular.',
        amount: '400 mg',
      },
      {
        name: 'Extracto de Espino Blanco (Crataegus oxyacantha)',
        description:
          'Rico en flavonoides cardiotónicos. Mejora la contractilidad cardíaca y dilata las arterias coronarias.',
        amount: '300 mg (estandarizado al 1.8% vitexina)',
      },
      {
        name: 'Extracto de Ajo Envejecido',
        description:
          'Rico en compuestos azufrados orgánicos que mejoran la circulación y tienen efectos cardioprotectores.',
        amount: '250 mg (equivalente a 2500mg de ajo fresco)',
      },
      {
        name: 'L-Taurina',
        description:
          'Aminoácido que mejora la función cardíaca, tiene efectos antiarrítmicos y apoya la presión arterial saludable.',
        amount: '500 mg',
      },
      {
        name: 'Vitamina E (d-alfa tocoferol)',
        description:
          'Antioxidante liposoluble que protege las membranas cardíacas del daño oxidativo.',
        amount: '400 UI',
      },
    ],
    dosage:
      'Tomar 2 cápsulas al día con alimentos, preferiblemente 1 con el desayuno y 1 con la cena. Para apoyo cardiovascular intensivo, puede incrementarse bajo supervisión médica.',
    administrationMethod:
      'Tomar con alimentos ricos en grasas para optimizar la absorción de CoQ10 y vitamina E. Mantener consistencia en horarios para niveles estables. Si toma medicamentos cardiovasculares, espaciar al menos 2 horas.',
    faqs: [
      {
        question: '¿Puedo tomarlo si ya tomo medicamentos para el corazón?',
        answer:
          'Consulte con su cardiólogo antes del uso. Algunos componentes pueden interactuar con medicamentos cardiovasculares, especialmente anticoagulantes y medicamentos para la presión arterial.',
      },
      {
        question: '¿Cuánto tiempo tardará en ver beneficios?',
        answer:
          'Los efectos energéticos pueden notarse en 2-4 semanas. Los beneficios cardiovasculares completos se desarrollan gradualmente durante 2-3 meses de uso consistente.',
      },
      {
        question: '¿Es seguro para personas con presión arterial baja?',
        answer:
          'Esta fórmula tiene efectos hipotensores naturales. Personas con presión arterial baja deben consultar con su médico antes del uso y monitorear la presión regularmente.',
      },
    ],
  },

  {
    ...
    price: 3245.67,
    description:
      'Omega-3 de grado farmacéutico con máxima concentración EPA/DHA. Destilado molecularmente para pureza superior. Apoyo cardiovascular y antiinflamatorio.',
    images: [
      {
    ...
    detailedDescription:
      'Omega-3 Ultra Pure ofrece la concentración más alta de EPA (ácido eicosapentaenoico) y DHA (ácido docosahexaenoico) en forma de triglicéridos naturales. Cada cápsula proporciona 1200mg de Omega-3 activos (EPA 720mg, DHA 480mg) derivados de peces de aguas profundas del Atlántico Norte. El aceite es destilado molecularmente para eliminar metales pesados, PCBs y dioxinas, garantizando pureza farmacéutica. Esta proporción 3:2 de EPA:DHA está optimizada para máximos beneficios cardiovasculares y antiinflamatorios.',
    mechanismOfAction:
    ...
    components: [
      {
        ...
        description:
          'Omega-3 con potentes efectos antiinflamatorios cardiovasculares. Precursor de mediadores especializados de resolución.',
        amount: '720 mg por cápsula',
      },
      {
        name: 'DHA (Ácido Docosahexaenoico)',
        description:
          'Omega-3 esencial para función cardíaca, cerebral y endotelial. Crucial para membrana celular y señalización.',
        amount: '480 mg por cápsula',
      },
      {
        name: 'Vitamina E natural (d-alfa tocoferol)',
        description:
          'Antioxidante que protege los Omega-3 de la oxidación y proporciona protección adicional al sistema cardiovascular.',
        amount: '10 UI',
      },
    ],
    dosage:
      'Tomar 1-2 cápsulas al día con alimentos ricos en grasas. Para apoyo cardiovascular intensivo o triglicéridos elevados, puede incrementarse a 3 cápsulas bajo supervisión médica.',
    administrationMethod:
      'Tomar con la comida más rica en grasas del día para maximizar absorción. Refrigerar después de abrir para mantener frescura. Si experimenta reflujo, congelar las cápsulas antes de tomar.',
    faqs: [
      {
        question: '¿Cuál es la diferencia entre EPA y DHA?',
        answer:
          'EPA tiene efectos más antiinflamatorios y cardiovasculares específicos, mientras que DHA es más importante para función cerebral y desarrollo. Esta fórmula 3:2 optimiza los beneficios cardiovasculares.',
      },
      {
        question: '¿Puedo tomarlo si tomo anticoagulantes?',
        answer:
          'Los Omega-3 tienen efectos anticoagulantes leves. Si toma warfarina u otros anticoagulantes, consulte con su médico y monitoree el INR regularmente.',
      },
      {
        question: '¿Cómo sé si el aceite está fresco?',
        answer:
          'Un aceite fresco no debe tener olor o sabor a pescado rancio. Nuestro producto incluye vitamina E como antioxidante y se recomienda refrigeración para mantener frescura óptima.',
      },
    ],
  },
  ...
  // 🦴 SISTEMA ÓSEO MINERAL - Productos para huesos, dientes y mineralización
  {
    ...
    price: 3987.65,
    description:
      'Fórmula sinérgica completa con Calcio, Magnesio, Vitamina D3, K2, Boro y Sílice. Apoyo integral para densidad ósea, dientes y mineralización.',
    images: [
      {
    ...
    detailedDescription:
      'Bone Matrix Pro es la formulación más avanzada para la salud ósea, combinando todos los nutrientes esenciales en proporciones optimizadas basadas en investigación científica. Esta fórmula sinérgica incluye formas altamente biodisponibles de Calcio (citrato y microhidrosipatita), Magnesio (citrato y malato), Vitamina D3 para absorción, Vitamina K2 para dirección del calcio, Boro para metabolismo mineral y Sílice para matriz ósea. Diseñada para personas preocupadas por la densidad ósea, especialmente mujeres postmenopáusicas y adultos mayores.',
    mechanismOfAction:
    ...
    components: [
      {
        ...
        description:
          'Combinación de formas altamente absorbibles. El citrato se absorbe sin ácido gástrico, la hidroxiapatita aporta matriz ósea completa.',
        amount: '1000 mg (100% VD)',
      },
      {
        name: 'Magnesio (como citrato y malato)',
        description:
          'Cofactor esencial para más de 300 enzimas, incluidas las que convierten vitamina D a su forma activa. Regula la deposición de calcio.',
        amount: '500 mg (119% VD)',
      },
      {
        name: 'Vitamina D3 (colecalciferol)',
        description:
          'Forma natural que aumenta la absorción intestinal de calcio y fósforo. Esencial para mineralización ósea adecuada.',
        amount: '2000 UI (500% VD)',
      },
      {
        name: 'Vitamina K2 (como MK-7)',
        description:
          'Activa osteocalcina para incorporar calcio en huesos y MGP para evitar calcificación arterial. Forma de larga duración.',
        amount: '120 mcg (100% VD)',
      },
      {
        name: 'Boro (como citrato de boro)',
        description:
          'Oligoelemento que mejora el metabolismo de calcio, magnesio y vitamina D. Reduce la excreción urinaria de calcio.',
        amount: '3 mg',
      },
      {
        name: 'Sílice (de extracto de bambú)',
        description:
          'Esencial para la síntesis de colágeno tipo I y la formación de la matriz ósea. Mejora la flexibilidad y resistencia ósea.',
        amount: '50 mg',
      },
      {
        name: 'Zinc (como picolinato)',
        description:
          'Cofactor para enzimas involucradas en la síntesis de colágeno y mineralización ósea.',
        amount: '15 mg (136% VD)',
      },
      {
        name: 'Manganeso (como gluconato)',
        description:
          'Necesario para la formación de cartílago y hueso. Cofactor de enzimas que sintetizan glucosaminoglicanos.',
        amount: '5 mg (217% VD)',
      },
    ],
    dosage:
      'Tomar 2-3 cápsulas al día con alimentos, preferiblemente divididas entre las comidas principales. Para máxima absorción, no tomar todas las cápsulas de una vez.',
    administrationMethod:
      'Tomar con alimentos para optimizar absorción de minerales. Dividir la dosis a lo largo del día ya que el cuerpo absorbe mejor pequeñas cantidades de calcio. Evitar tomar con alimentos ricos en fibra o oxalatos que pueden interferir con la absorción.',
    faqs: [
      {
        question: '¿Por qué incluye vitamina K2 junto con calcio?',
        answer:
          'La vitamina K2 es crucial para dirigir el calcio hacia los huesos y dientes, evitando que se deposite en arterias y tejidos blandos. Sin K2, el calcio suplementario puede calcificar arterias.',
      },
      {
        question: '¿Cuál es la proporción ideal de calcio y magnesio?',
        answer:
          'Usamos una proporción 2:1 (calcio:magnesio) que permite la absorción óptima de ambos minerales y refleja las necesidades metabólicas del cuerpo para el equilibrio mineral.',
      },
      {
        question: '¿Cuándo veré mejoras en la densidad ósea?',
        answer:
          'Los cambios en densidad ósea son graduales. Los marcadores bioquímicos pueden mejorar en 3-6 meses, pero los cambios significativos en densitometría ósea generalmente se observan después de 12-24 meses de suplementación consistente.',
      },
    ],
  },

  {
    ...
    price: 2345.78,
    description:
      'Fórmula sinérgica de Calcio, Vitamina D3 y K2 en proporciones científicamente validadas. Máxima absorción y dirección correcta del calcio.',
    images: [
      {
    ...
    components: [
      {
        name: 'Calcio (como citrato de calcio)',
        description:
          'Forma altamente biodisponible que se absorbe independientemente del ácido gástrico. Ideal para adultos mayores.',
        amount: '600 mg (60% VD)',
      },
      {
        name: 'Vitamina D3 (colecalciferol)',
        description:
          'Forma natural idéntica a la producida por la piel. Optimiza la absorción intestinal de calcio.',
        amount: '2000 UI (500% VD)',
      },
      {
        name: 'Vitamina K2 (como menaquinona-7 MK-7)',
        description:
          'Forma de larga duración que activa proteínas para dirigir calcio a huesos y evitar calcificación arterial.',
        amount: '100 mcg (83% VD)',
      },
    ],
    dosage:
      'Tomar 2 comprimidos al día con alimentos, preferiblemente 1 con el desayuno y 1 con la cena para mantener niveles estables de calcio.',
    administrationMethod:
      'Tomar con alimentos para optimizar absorción. Espaciar de suplementos de hierro, zinc o antibióticos al menos 2 horas. Para personas que toman anticoagulantes, consultar médico debido a la vitamina K2.',
    faqs: [
      {
        question:
          '¿Es seguro combinar calcio con vitamina K2 si tomo anticoagulantes?',
        answer:
          'La vitamina K2 puede afectar la anticoagulación. Si toma warfarina u otros anticoagulantes, consulte con su médico antes de usar y monitoree el INR regularmente.',
      },
      {
        question: '¿Por qué citrato de calcio en lugar de carbonato?',
        answer:
          'El citrato de calcio se absorbe mejor (especialmente con el estómago vacío), no requiere ácido gástrico y tiene menor riesgo de causar cálculos renales comparado con el carbonato.',
      },
      {
        question: '¿Puedo tomar toda la dosis de una vez?',
        answer:
          'Es mejor dividir la dosis porque el cuerpo absorbe máximo 500mg de calcio por vez. Tomar en dosis divididas asegura mejor absorción y utilización.',
      },
    ],
  },
];
