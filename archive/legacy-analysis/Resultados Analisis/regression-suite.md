...
| ------------------ | -------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Unit (Vitest)      | Hooks, contextos, utils (`frontend-core`, `state`) | `npm run test -- --runInBand`                                                         | Incluir mocks para localStorage, sanitizer, hooks SEO/analytics. Cobertura objetivo ≥80 %.                                                             |
