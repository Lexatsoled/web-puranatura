 ...
 * Propósito: Selector compacto y accesible para elegir cantidades
 *            con botones +/- y entrada numérica controlada.
 * Entradas:
 *  - min, max: Límites inferior y superior permitidos
 *  - value: Valor inicial mostrado
 *  - onChange: Callback que notifica el nuevo valor seleccionado
 *  - size: Tamaño visual ('sm' | 'md' | 'lg')
 *  - variant: Estilo visual ('default' | 'white')
 *  - disabled: Desactiva interacción cuando es true
 * Comportamiento: Asegura que el valor permanezca siempre entre min y max.
 */
