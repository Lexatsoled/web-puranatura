...
| R5  | Endpoint AI (retired)           | L    | M       | Endpoint removed; prefer external orchestration (n8n) and external rate-limit + billing controls | no endpoint in runtime; integration via external webhook may have risks |
