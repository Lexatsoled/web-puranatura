        ...
        <div className="bg-emerald-50 py-16 md:py-24">
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-5xl font-bold font-display text-green-800">Ponte en Contacto</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div className="bg-white/60 backdrop-blur-sm p-8 rounded-lg shadow-lg">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div>
                                ...
                                <input type="text" name="name" id="name" required value={formData.name} onChange={handleChange} className="mt-1 block w-full px-3 py-2 bg-white/80 border border-green-200 rounded-md shadow-sm focus:outline-none focus:ring-green-400 focus:border-green-500"/>
                            </div>
                             <div>
                                <label htmlFor="email" className="block text-sm font-medium text-gray-700">Correo Electrónico</label>
                                <input type="email" name="email" id="email" required value={formData.email} onChange={handleChange} className="mt-1 block w-full px-3 py-2 bg-white/80 border border-green-200 rounded-md shadow-sm focus:outline-none focus:ring-green-400 focus:border-green-500"/>
                            </div>
                            <div>
                                <label htmlFor="message" className="block text-sm font-medium text-gray-700">Mensaje</label>
                                <textarea name="message" id="message" rows={5} required value={formData.message} onChange={handleChange} className="mt-1 block w-full px-3 py-2 bg-white/80 border border-green-200 rounded-md shadow-sm focus:outline-none focus:ring-green-400 focus:border-green-500"></textarea>
                            </div>
                            <div>
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 mt-2">Calle de la Salud 123, Ensanche Paraíso</p>
