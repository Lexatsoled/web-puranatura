      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600">
            {cart.count > 0 ? (
              <>Tienes {cart.count} {cart.count === 1 ? 'producto' : 'productos'} en tu carrito</>
            ) : (
        ...
        {cart.items.length === 0 ? (
          ...
          >
            <div className="max-w-md mx-auto">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 mb-3">Tu carrito está vacío</h2>
              <p className="text-gray-500 mb-8">¡Descubre nuestros productos naturales y comienza tu journey hacia el bienestar!</p>
                            ...
                            <div className="flex justify-between">
                              <div>
                                ...
                                <p className="mt-1 text-sm text-gray-500">
                                  {item.product.categories ? item.product.categories.join(', ') : ''}
                                </p>
                            ...
                            <div className="mt-4 flex items-center justify-between">
                              <div className="flex items-center space-x-3">
                                ...
                                {item.quantity >= item.product.stock && (
                                  <span className="text-xs text-orange-600">Stock limitado</span>
                                )}
                              </div>
                    ...
                    <div className="p-4 bg-blue-50 border border-blue-200 rounded-md">
                      ...
                      <div className="w-full bg-blue-200 rounded-full h-2">
                        <div 
                          ...
                          style={{ width: `${Math.min((cart.total / 3000) * 100, 100)}%` }}
                        />
                      </div>
                    </div>
                  )}
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    <div className="flex justify-between text-base font-medium">
                      ...
                      <span className="text-emerald-600">
                        {formatPrice(cart.total + (cart.total >= 3000 ? 0 : 200))}
                      </span>
                    </div>
                    <p className="mt-1 text-sm text-gray-500">
                      Impuestos incluidos
            ...
            >
              ...
              >
                ...
                <p className="text-sm text-gray-500 mb-6">
                  ¿Estás seguro de que quieres vaciar el carrito? Esta acción eliminará todos los productos y no se puede deshacer.
                </p>
